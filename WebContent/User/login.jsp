...
<body>
				...
				<form method="post" role="form" id="form_log"
					action="<%=request.getContextPath()%>/LoginServlet?type=user" class= "validate">
					<center>
					<img alt="" src="../images/logo.png" width="350" height="150" style="margin-top:10%"></center>	
					<br/>
					<h4 id="msg"></h4>
					...
					<div class="col-sm-3" style="margin-left:38%">
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="username"
									id="username" placeholder="Username" autocomplete="off" maxlength="12" data-validate="required"
						...
						<div class="form-group">
							...
							<a href="<%=request.getContextPath()%>/User/registration_UI.jsp"><button type="button" class="btn btn-success" name="nSubmit">Signup</button></a>
						</div>
					<!-- <div class="form-group">
					<a href="forgotPwd.jsp" onclick="return openForm();">Forgot your Password?</a>
					</div> -->
					</div>
		            </center>
				</form>
