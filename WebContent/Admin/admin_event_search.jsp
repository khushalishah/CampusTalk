						...
						<table class="table table-bordered datatable" id="table-1">
							...
							<tbody>
								...
								<tr class="odd gradeX">
									...
									<td><%=ev.getEvent_startDate()%></td>
									<td><%=ev.getEvent_endDate()%></td>
									<td><a
										href="event_edit.jsp?id=<%=ev.getEvent_id()%>&title=<%=ev.getEvent_title()%>&desc=<%=ev.getEvent_description()%>&startDate=<%=ev.getEvent_startDate()%>&endDate=<%=ev.getEvent_endDate()%>&enroll=<%=ev.getEvent_enrollment()%>"
