...
<title>Campus Talk | feedback</title>
</head>
				...
				<div class="row">
					<div class="row draggable-portlets">
						...
						<table class="table table-bordered datatable" id="table-1">
							...
							<tbody>
								<%
									ArrayList<FeedbackVo> ls = (ArrayList) session.getAttribute("feedback_list");

									for (FeedbackVo fv : ls) {
								%>
								<tr class="odd gradeX">
									<td><%=fv.getfId()%></td>
									<td><%=fv.getfNameOfTeacher()%></td>
									<td><%=fv.getfCourseCode()%></td>
									<td><%=fv.getfCourseTitle()%></td>
									<td><%=fv.getfSemester()%></td>
									<td><a
										href="<%=request.getContextPath()%>/CTServlet?type=feedback&operation=delete&id=<%=fv.getfId()%>"
										...
										<button class="btn btn-info btn-sm btn-icon icon-left"
											...
											data-content="<table><tr><td>Criteria<td>Ratings</tr>
												<tr><td>Completion of Syllabus : <td><%=fv.getQue1()%></tr>
												<tr><td>Topic Discussion : <td><%=fv.getQue2()%></tr>
												<tr><td>Communication : <td><%=fv.getQue3()%></tr>
												<tr><td>Punctual : <td><%=fv.getQue4()%></tr>
												<tr><td>Well Prepared : <td><%=fv.getQue5()%></tr>
												<tr><td>Encouraging : <td><%=fv.getQue6()%></tr>
												<tr><td>Use of modern teaching aids : <td><%=fv.getQue7()%></tr>
												<tr><td>Friendly and helpful attitude : <td><%=fv.getQue8()%></tr>
												<tr><td>Availability and accessibilty of faculty : <td><%=fv.getQue9()%></tr>
												<tr><td>Fair and unbiased evaluation process : <td><%=fv.getQue10()%></tr>
												<tr><td>Regular feedback on students' performance : <td><%=fv.getQue11()%></tr>
												<tr><td>Periodical Assessment : <td><%=fv.getQue12()%>
												<tr><td>Student understanding of subject : <td><%=fv.getQue13()%></tr>
												<tr><td>Comments : <td><%=fv.getfComment()%></tr></table>"
