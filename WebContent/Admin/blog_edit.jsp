...
<body class="page-body" data-url="http://demo.neontheme.com">
	...
	<div class="page-container">
					...
					<div class="panel panel-primary" data-collapsed="0">
						<div class="panel-body">
							<form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<%=request.getContextPath()%>/CTServlet?type=blog&operation=edit&id=<%=request.getParameter("id")%>" enctype="multipart/form-data">
									...
									<div class="col-sm-5">
											<select name="blog_category" class="selectboxit" id="category">
											<option>Art</option>
								...
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Enrollment*
										Id</label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-2" name="blog_enrollment" value="<%=bv1.getBlog_enrollment() %>" data-validate="required" data-message-required="Please enter enrollment number" value="<%=session.getAttribute("enrollment") %>" readonly>
									</div>
								</div>
								<div class="form-group">
										...
										if(!bv1.getBlog_file().equals("")){			
											...
											<div class="fileinput fileinput-new"
												...
												<div class="fileinput-new thumbnail"
													...
													<img src="<%=request.getContextPath() %>/ImageServlet?imageID=<%=bv1.getBlog_file() %>" alt="...">
												</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<textarea class="form-control" id="field-ta" name="blog_description" data-validate="required" data-message-required="Please enter description"><%=bv1.getBlog_description() %></textarea>
									</div>
								</div>
						<p>
					<center>
		...
		<script src="../js/dept&semSelection.js" id="script-resource-21"></script>
					...
					jQuery(document).ready(function($){
						setCategory('<%=bv1.getBlog_category()%>');
						});
