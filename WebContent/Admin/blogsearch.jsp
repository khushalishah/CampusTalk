				...
				<div class="row">
					<div class="row draggable-portlets">
						...
						<table class="table table-bordered datatable" id="table-1">
							...
							<tbody>
								<%
									ArrayList<BlogsVo> ls = (ArrayList) session.getAttribute("list");
								...
								<tr class="odd gradeX">
									<td><%=bv.getBlog_id()%></td>
									<td><%=bv.getBlog_name()%></td>
									<td><%=bv.getBlog_enrollment()%></td>
									<td><%=bv.getBlog_category()%></td>
									<td><%=strDate%></td>
									<td><a href="blog_edit.jsp?id=<%=bv.getBlog_id()%>"
										class="btn btn-default btn-sm btn-icon icon-left"> <i
											class="entypo-pencil"></i> Edit
									</a> <a
										href="<%=request.getContextPath()%>/CTServlet?type=blog&operation=delete&id=<%=bv.getBlog_id()%>"
										...
										<button class="btn btn-info btn-sm btn-icon icon-left"
											...
											data-placement="left"
											data-content="<%=bv.getBlog_description()%>"
											data-original-title="<%=bv.getBlog_title()%>">
